...
def run():
    ...
    project_data = [
        ...
        ("Projet Electronique", "Projet de conception backend site électronique", "BACK_END", user7),
        ("Projet Site Web Corporate", "Création de site web pour une agence digitale", "FRONT_END", user8),
        ("Projet de gestion d'animalerie", "Projet de gestion de stock pour une animalerie", "IOS", user9),
        ("Projet d'application comptabilité", "Application mobile de comptabilité", "ANDROID", user10),
        ("Projet d'application mobile pour fleuriste", "Application mobile pour un fleuriste", "ANDROID", user11),
        ("Projet de rebranding site existant", "Rebranding d'un site existant", "FRONT_END", user12),
        ("Projet de gestion financière", "Projet de gestion financière pour un magasin", "BACK_END", user13),
        ("Projet d'application mobile pour un restaurant", "Application mobile pour un restaurant", "ANDROID", user14),
        ("Projet de conception de site web avec réservation", "Conception de site web avec réservation hôtel", "FRONT_END", user15),
        ("Projet de gestion d'actions en bourse", "Projet de gestion d'actions en bourse", "BACK_END", user16),
        ("Projet d'application IOS pour un transporteur", "Application IOS pour un transporteur", "IOS", user17),
        ("Projet d'amélioration site web restaurateur", "Amélioration site web restaurateur", "FRONT_END", user18),
        ("Projet de gestion de stock pour une pharmacie", "Projet de gestion de stock pour une pharmacie", "IOS", user19),
        ("Projet de conception de site web pour un hôtel", "Conception de site web pour un hôtel", "FRONT_END", user20),
    ]
    ...
    project14 = Project.objects.get(title="Projet d'application mobile pour un restaurant")
    project15 = Project.objects.get(title="Projet de conception de site web avec réservation")
    project16 = Project.objects.get(title="Projet de gestion d'actions en bourse")
    project17 = Project.objects.get(title="Projet d'application IOS pour un transporteur")
    project18 = Project.objects.get(title="Projet d'amélioration site web restaurateur")
    project19 = Project.objects.get(title="Projet de gestion de stock pour une pharmacie")
    project20 = Project.objects.get(title="Projet de conception de site web pour un hôtel")
    ...
    issue_data = [
        ("Problème de connexion", "Impossible de se connecter à l'application", "HIGH", "BUG", "TO_DO", project1, user1, user1),
        ("Problème de paiement", "Impossible de payer en ligne", "MEDIUM", "BUG", "IN_PROGRESS", project2, user2, user2),
        ("Problème de stock", "Le stock est vide", "HIGH", "BUG", "TO_DO", project3, user3, user3),
        ("Problème d'authentification", "Impossible de s'authentifier à l'application", "HIGH", "BUG", "TO_DO", project4, user4, user4),
        ("Problème de design au niveau du header", "Le design du header est à revoir", "MEDIUM", "BUG", "IN_PROGRESS", project5, user5, user5),
        ("Problème de connexion", "Impossible de se connecter à l'application", "HIGH", "BUG", "TO_DO", project6, user6, user6),
        ("Souci au niveau de JWT", "Problème de JWT", "MEDIUM", "BUG", "IN_PROGRESS", project7, user7, user7),
        ("Problème installation Tailwind", "NPM à vérifier", "HIGH", "BUG", "TO_DO", project8, user8, user8),
        ("Base de données non accessible", "Problème de connexion à la base de données", "HIGH", "BUG", "TO_DO", project9, user9, user9),
        ("Plan comptable non conforme", "Problème de plan comptable", "MEDIUM", "BUG", "IN_PROGRESS", project10, user10, user10),
        ("Système de paiement Stripe non fonctionnel", "Problème de paiement", "HIGH", "BUG", "TO_DO", project11, user11, user11),
        ("Logo à refaire selon nouveau charte graphique", "Problème de logo", "MEDIUM", "BUG", "IN_PROGRESS", project12, user12, user12),
        ("Programme d'évaluation forex non fonctionnel", "Problème de programme forex", "HIGH", "BUG", "TO_DO", project13, user13, user13),
        ("Système de réservation de table à vérifier", "Problème de réservation", "MEDIUM", "BUG", "IN_PROGRESS", project14, user14, user14),
        ("Système de booking de vols non fonctionnel", "Problème de booking", "HIGH", "BUG", "TO_DO", project15, user15, user15),
        ("Affichage des actions disponibles à revoir", "Problème d'affichage", "MEDIUM", "BUG", "IN_PROGRESS", project16, user16, user16),
        ("Système de suivi de colis à mettre en place", "Problème de suivi de colis", "HIGH", "BUG", "TO_DO", project17, user17, user17),
        ("Version mobile du site à revoir", "Problème de version mobile", "MEDIUM", "BUG", "IN_PROGRESS", project18, user18, user18),
        ("Différence de stocks entre le site et la pharmacie", "Problème de stock", "HIGH", "BUG", "TO_DO", project19, user19, user19),
        ("Système de réservation de chambre à vérifier", "Problème de réservation", "MEDIUM", "BUG", "IN_PROGRESS", project20, user20, user20),
    ]

    issues = []

    for title, description, priority, tag, status, project, author_user, assignee in issue_data:
    ...
    comments_data = [
        ...
        ("Affichage des actions en cours de modification, voir GitHub Repo Forex", issues[16], user17),
